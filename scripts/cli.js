...
const contractABI = require("../artifacts/contracts/Harmonykite.sol/Harmonykite.json").abi;

program
    .name("harmonykite-cli")
    .description("CLI tool for Harmonykite smart contract")
    .version("1.0.0");
